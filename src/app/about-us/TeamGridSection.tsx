    ...
    <section className="w-full py-10 md:py-16 px-2 md:px-4 bg-white mx-auto" id="team">
      ...
      <div className="flex items-center justify-center gap-6 md:gap-10">
        {members.map((member, idx) => (
          <div key={idx} className="flex flex-col rounded-xl p-2">
            <div className="w-full mb-2 md:mb-4 relative">
              <Image src={member.imgSrc} alt={member.name} width={100} height={100} className="h-[180px] md:h-[200px] w-[200px] object-cover border-2 border-primary-green p-2 rounded-full" />
            </div>
