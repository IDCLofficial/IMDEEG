...
export default function Advertisement() {
  return (
    <motion.section 
      ...
      viewport={{ once: false }}
      className="w-full px-4 md:px-8 py-8 md:py-12 mt-10 lg:mt-8 bg-white flex flex-col lg:flex-row justify-between items-center gap-8 md:gap-18 shadow-md border border-gray-200"
    >
      {/* Flier Image */}
      <motion.div 
